-- =====================================================
-- COMPLETE SUPABASE SETUP FOR HOTEL MANAGEMENT SYSTEM
-- =====================================================
...
-- 18. Create a super admin (optional - replace with your email)
-- Uncomment and modify the following lines to create a super admin:
/*
...
-- Then update the admin status
UPDATE admin_users 
SET is_admin = true 
WHERE user_id = (SELECT id FROM auth.users WHERE email = 'admin@yourhotel.com');
*/
